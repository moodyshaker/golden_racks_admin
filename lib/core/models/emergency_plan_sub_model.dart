...
class EmergencyPlanSubModel {
  ...
  Map<String, dynamic> toJson() {
    return <String, dynamic>{
      'visitWithSubscribeId': visitWithSubscribeId,
      'id': id,
  ...
  factory EmergencyPlanSubModel.fromJson(Map<String, dynamic> json) {
    return EmergencyPlanSubModel(
      visitWithSubscribeId: json['visitWithSubscribeId'] != null
          ? json['visitWithSubscribeId'] as int
          : null,
...
class ProblemDetails {
  int? visitWithSubscripeId;
  String? fileName;
  ProblemDetails({
    this.visitWithSubscripeId,
    this.fileName,
  });

  Map<String, dynamic> toJson() {
    return <String, dynamic>{
      'visitWithoutSubscripeId': visitWithSubscripeId,
      'fileName': fileName,
    };
  }
  ...
  factory ProblemDetails.fromJson(Map<String, dynamic> json) {
    return ProblemDetails(
      visitWithSubscripeId: json['visitWithSubscripeId'] != null
          ? json['visitWithSubscripeId'] as int
          : null,
