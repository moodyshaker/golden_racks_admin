...
class AdminAssignTechnicalForEmergencyUnsubScreen extends StatefulWidget {
  final EmergencyPlanUnSubModel emergencyUnsub;

  AdminAssignTechnicalForEmergencyUnsubScreen({required this.emergencyUnsub});

  @override
  State<AdminAssignTechnicalForEmergencyUnsubScreen> createState() =>
      _AdminAssignTechnicalForEmergencyUnsubScreenState();
}

class _AdminAssignTechnicalForEmergencyUnsubScreenState
    extends State<AdminAssignTechnicalForEmergencyUnsubScreen> {
                                                      ...
                                                      MaterialButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          await emergencyUnsubProvider
                                                              .assignTechForUnsubEmergency(
                                                            UserId: _preferences
                                                                .getUserId,
                                                            TechnicalId:
                                                                '2230e6ec-b2f2-452b-a453-c441349e7f9b',
