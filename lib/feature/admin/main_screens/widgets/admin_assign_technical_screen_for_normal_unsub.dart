...
class AdminAssignTechnicalForNormalUnsubScreen extends StatefulWidget {
  final NormalPlanUnSubModel normalUnsub;

  AdminAssignTechnicalForNormalUnsubScreen({required this.normalUnsub});

  @override
  State<AdminAssignTechnicalForNormalUnsubScreen> createState() =>
      _AdminAssignTechnicalForNormalUnsubScreenState();
}

class _AdminAssignTechnicalForNormalUnsubScreenState
    extends State<AdminAssignTechnicalForNormalUnsubScreen> {
