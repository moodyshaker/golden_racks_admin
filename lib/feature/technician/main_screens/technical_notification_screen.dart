...
class TechnicalNotificationScreen extends StatefulWidget {
  @override
  State<TechnicalNotificationScreen> createState() =>
      _TechnicalNotificationScreenState();
}

class _TechnicalNotificationScreenState
    extends State<TechnicalNotificationScreen> {
  @override
  void initState() {
    super.initState();
