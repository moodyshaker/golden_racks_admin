...
class NormalUnsubTicketTechViewScreen extends StatefulWidget {
  const NormalUnsubTicketTechViewScreen({Key? key}) : super(key: key);

  @override
  State<NormalUnsubTicketTechViewScreen> createState() =>
      _NormalUnsubTicketTechViewScreenState();
}

class _NormalUnsubTicketTechViewScreenState
    extends State<NormalUnsubTicketTechViewScreen> {
  @override
  void initState() {
    super.initState();
  }
